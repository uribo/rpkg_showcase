...
[![](http://www.r-pkg.org/badges/version/dplyr)](http://cran.rstudio.com/web/packages/dplyr/index.html)

* CRAN: http://cran.r-project.org/web/packages/dplyr/index.html
* GitHub: http://github.com/hadley/dplyr

```{r}
library(dplyr)
```

バージョン: `r packageVersion("dplyr")`

-----

```{r, echo = FALSE, results = "asis", eval = FALSE}
library(help = "dplyr")$info[[2]] %>% data.frame() %>% kable()
```
