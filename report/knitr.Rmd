...
R上で動的レポートを作成するためのパッケージ

[![](http://www.r-pkg.org/badges/version/knitr)](http://cran.rstudio.com/web/packages/knitr/index.html)
...
バージョン: `r packageVersion("knitr")`

-----

```{r, echo = FALSE, results = "asis", eval = FALSE}
library(help = "knitr")$info[[2]] %>% data.frame() %>% kable()
```
...
| `rand_seed` | An unevaluated expression to return ImageMagick |
