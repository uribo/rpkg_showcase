...
[![](http://www.r-pkg.org/badges/version/devtools)](http://cran.rstudio.com/web/packages/devtools/index.html)

* CRAN: http://cran.r-project.org/web/packages/devtools/index.html
* GitHub: http://github.com/hadley/devtools

```{r}
library(devtools)
```

バージョン: `r packageVersion("devtools")`

-----

```{r, echo = FALSE, results = "asis", eval = FALSE}
library(help = "devtools")$info[[2]] %>% data.frame() %>% kable()
```
